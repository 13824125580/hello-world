...
void GUI_DrawBitmapEx(const GUI_BITMAP GUI_UNI_PTR * pBitmap, int x0, int y0,
  ...
  OldIndex = LCD_GetColorIndex();
    ...
    WM_ADDORG(x0, y0);
    if (xMag >= 0) {
      r.x0 = (short)(x0 + GUI__DivideRound32(((I32)(-xCenter) * (I32)(xMag)), 1000));
      r.x1 = (short)(x0 + GUI__DivideRound32(((I32)(pBitmap->XSize - xCenter - 1) * (I32)(xMag)), 1000));
    } else {
      r.x1 = (short)(x0 + GUI__DivideRound32(((I32)(-xCenter) * (I32)(xMag)), 1000));
      r.x0 = (short)(x0 + GUI__DivideRound32(((I32)(pBitmap->XSize - xCenter - 1) * (I32)(xMag)), 1000));
    }
    if (yMag >= 0) {
      r.y0 = (short)(y0 + GUI__DivideRound32(((I32)(-yCenter) * (I32)(yMag)), 1000));
      r.y1 = (short)(y0 + GUI__DivideRound32(((I32)(pBitmap->YSize - yCenter - 1) * (I32)(yMag)), 1000));
    } else {
      r.y1 = (short)(y0 + GUI__DivideRound32(((I32)(-yCenter) * (I32)(yMag)), 1000));
      r.y0 = (short)(y0 + GUI__DivideRound32(((I32)(pBitmap->YSize - yCenter - 1) * (I32)(yMag)), 1000));
    }
    WM_ITERATE_START(&r) {
  #endif
